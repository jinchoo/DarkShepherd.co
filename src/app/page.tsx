...
export default function Home() {
  return (
    <div id="top" className="font-display relative h-[100dvh] overflow-hidden bg-[#050816] text-slate-100">
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl flex-col overflow-visible px-6 pt-2 sm:px-8 lg:max-w-7xl lg:px-12">
        <main className="relative mt-0 flex-1 overflow-visible lg:mt-0">
          ...
          <section className="relative mx-auto w-full max-w-6xl overflow-hidden px-4 pt-[68px] pb-0 md:px-6 lg:max-w-7xl lg:px-8">
